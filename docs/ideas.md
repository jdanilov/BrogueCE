...
2. Weighted item & monster placement - try to place items and stationary / sleeping into interesting rooms, near fixtures. [done]

3. Items on monsters - make 1/3 of all items appear on monsters, so chasing and killing monsters incentivised. Could be an interesting mechanics, e.g. assign special item pools to special monsters (e.g. mango to monkeys - need to think this through). [done]
...
6. Environmental storytelling rooms — Pre-built "set pieces" — a collapsed library with a guaranteed scroll, a flooded alchemy lab with potions, an abandoned forge near a weapon. Connects loot to place. [done]
