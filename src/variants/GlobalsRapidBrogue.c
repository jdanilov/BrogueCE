...
const short itemGenerationProbabilities_RapidBrogue[NUMBER_ITEM_CATEGORIES] = {50,    84,     104,     3,      3,     10,     8,      2,      3,      2,        0,        0,      0,      3,      0};
...
itemTable rangedWeaponTable_RapidBrogue[] = {
...
const gameConstants rapidBrogueGameConst = {
    ...
    .numberRangedKinds = sizeof(rangedWeaponTable_RapidBrogue) / sizeof(itemTable),
...
void initializeGameVariantRapidBrogue(void) {
    ...
    rangedWeaponTable = rangedWeaponTable_RapidBrogue;
