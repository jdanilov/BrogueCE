...
enum dungeonFeatureTypes {
    ...
    DF_HALLUCINATION_GAS_CLOUD_POTION,
...
enum terrainFlagCatalog {
    ...
    T_CAUSES_HALLUCINATION          = Fl(22),       // causes creatures on this tile to hallucinate
    ...
    T_HARMFUL_TERRAIN               = (T_CAUSES_POISON | T_IS_FIRE | T_CAUSES_DAMAGE | T_CAUSES_PARALYSIS | T_CAUSES_CONFUSION | T_CAUSES_EXPLOSIVE_DAMAGE | T_CAUSES_HALLUCINATION),
    T_RESPIRATION_IMMUNITIES        = (T_CAUSES_DAMAGE | T_CAUSES_CONFUSION | T_CAUSES_PARALYSIS | T_CAUSES_NAUSEA | T_CAUSES_HALLUCINATION),
};
...
enum machineTypes {
    ...
    MT_FIXTURE_COLLAPSED_PILLAR,
    MT_FIXTURE_DRAINAGE_CHANNEL,
    MT_FIXTURE_MOSSY_ALCOVE,
    MT_FIXTURE_COBWEB_CORNER,
    MT_FIXTURE_CRUMBLED_WALL,
    MT_FIXTURE_DUST_MOTES,
    MT_FIXTURE_MUSHROOM_CIRCLE,
    MT_FIXTURE_SUNLIT_PATCH,
    MT_FIXTURE_BIRD_NEST,
    ...
    MT_FIXTURE_ABANDONED_CAMP,
    MT_FIXTURE_WEAPON_RACK,
    MT_FIXTURE_SCORCHED_EARTH,
    MT_FIXTURE_LICHEN_GARDEN,
    MT_FIXTURE_TOPPLED_BOOKCASE,
    MT_FIXTURE_BONE_THRONE,
    MT_FIXTURE_BLOOD_POOL,
    MT_FIXTURE_OBSIDIAN_FORMATION,
    MT_FIXTURE_EMBER_PIT,
    MT_FIXTURE_CLAW_MARKS,
    MT_FIXTURE_SACRIFICIAL_SLAB,
    MT_FIXTURE_SULFUR_CRUST
};
