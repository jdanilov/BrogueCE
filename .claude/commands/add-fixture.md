...
Current last fixture in the enum: `MT_FIXTURE_COBWEB_CORNER = 80`
Blueprint catalog currently has **81 entries** (indices 0–80).
New fixture will be: enum value **81**, catalog index **81**.
